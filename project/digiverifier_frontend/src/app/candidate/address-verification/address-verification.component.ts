...
export class AddressVerificationComponent implements OnInit {
  ...
  constructor(private candidateService: CandidateService,private authService:AuthenticationService, private navrouter: Router, private router:ActivatedRoute,private customers:CustomerService) {
