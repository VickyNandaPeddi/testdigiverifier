...
public interface CandidateCafExperienceRepository extends JpaRepository<CandidateCafExperience, Long> {
	...
	@Query(value="From CandidateCafExperience where candidate.candidateId=:candidateId and serviceSourceMaster.serviceCode in:codes")
	List<CandidateCafExperience> findByServiceSourceMasterCodes(@Param("candidateId")Long candidateId,@Param("codes")List<String> codes);
