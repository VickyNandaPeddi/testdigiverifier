...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query(value = "SELECT u FROM User u WHERE u.userFirstName = :userFirstName")
	User findByUserFirstNameForSearchCandidate(@Param("userFirstName") String userFirstName);
